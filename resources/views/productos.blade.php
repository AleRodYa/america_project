...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <img class="img-fluid img-america" src="{{URL::asset('/images/logo.png')}}" alt="America Car Rental" >
        ...
        <div class="">
          ...
          <h4>Autos disponibles para ti</h4>
           

                <div class="row">
                    @foreach($productos as $producto)
                        <div class="col-sm-2">
                            <img src="{{ $producto->foto}}" width="130" height="90">
                            <h4>{{ $producto->nombre }}</h4>
                            <h2>Precio: {{ $producto->precio}}</h2>

                            <a href="{{url('cart/'.$producto->id)}}" class="btn btn-primary btn-md btn-block" role="button" aria-pressed="true"><p>RESERVAR AUTO</p></a>
                            <a href="{{url('product-detail/'.$producto->id)}}" class="btn btn-primary btn-md btn-block" role="button" aria-pressed="true"><p>VER DETALLES DE AUTO</p></a>
